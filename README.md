A Terraform/CX as Code remote module for the following Genesys Cloud public API operation: Get Customer Participant
...
```hcl
module "data_action" {
    source             = "git::https://github.com/GenesysCloudDevOps/public-api-get-customer-participant-data-action-module.git?ref=v1.0.0"
    action_name        = "Get Customer Participant"
